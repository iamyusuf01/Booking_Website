...
const Appoinments = () => {
  ...
  const getAvailableSlots = async () => {
    ...
    while(currentDate < endTime) {
     ...
     //Increament current date by 30 minutes
  ...
  return docInfo &&  (
     <div>
        <div className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex-1 border border-gray-400 roumded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0 '>
          ...
          <div className='flex gap-3 items-center w-full overflow-x-scroll mt-4'>
            {
              docSlots.length && docSlots.map((item, index) => (
                <div onClick={() => setSlotIndex(index) }
                  ...
                  <p>{item[0] && dayOfWeak[item[0].datetime.getDay()]}</p>
